                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 pl-0 pr-0">
                                ...
                                <div class="container p-0">
                                    <div class="slider-for" style="height: 260px; width: 100%;">
                                        <div>
                                            <a href="<?php echo base_url() . 'uploads/produk/'. $i->foto_produk ?>" data-rel="prettyPhoto">
                                                <img class="img-fluid" style="width: 100%; height: 270px;"
                                                    src="<?php echo base_url() . 'uploads/produk/'. $i->foto_produk ?>">
                                            </a>
                                        </div>
                                        <div>
                                            <a href="<?php echo base_url() . 'uploads/produk/'. $i->foto_produk ?>" data-rel="prettyPhoto">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 pt-2 pb-2">
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 col-xs-12 pt-3 pb-3">
                                        <h4><?php echo $i->nama_produk; ?></h4>
                                        <span class="h6 font-weight-bold"><?php echo $i->harga; ?></span>
                                        <p class="text-muted mb-2"><small><?php echo $i->deskripsi; ?></small></p>
                    ...
                    <div class="container card-box">
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-xs-12 p-3 "
                                ...
                                <p class="h4 font-weight-bold text-center" style="color: white;">Rp <?php echo $i->harga;?> </p>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-6 col-xs-12 w-50 mt-3">
                                            <p class="h4 font-weight-bold"><?php echo $i->diskon;?></p>
                                            <p class="h6 font-weight-bold"><?php echo $i->berat_produk;?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-xs-12  pl-3 pr-3 pt-3 pb-4">
                                <button type="button" class="btn btn-danger btn-block"><?php echo $i->nama_produk;?></button>
                            ...
                            <div class="col-lg-10 col-md-6 col-xs-12 pt-4 pb-4 ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-xs-12 w-50 pl-0">
                                        <ul style="list-style: none; padding-inline-start:0px">
                                            <li class="display-6">: <b><?php echo $i->nama_produk;?></b> </li>
                                            <li class="display-6">: <b><?php echo $i->nama_produk;?>m<sup>2</sup></b></li>
                                            <li class="display-6">: <b><?php echo $i->harga;?>m<sup>2</sup></b></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-xs-12 w-50 pr-0">
                                        <ul style="list-style: none; padding-inline-start:0px">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-xs-12 w-50 pl-0">
                                        <ul style="list-style: none; padding-inline-start:0px">
                                            <li class="display-6">: <b><?php echo $i->nama_produk;?></b> Fasilitas</li>
                                            <li class="display-6">: <b><?php echo $i->nama_produk;?></b> Km</li>
                                            <li class="display-6">: Rp. <b><?php echo $i->harga;?></b></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-10 col-md-6 col-xs-12 pt-2 pb-4 ">
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 col-xs-12">
                                        <p class="display-6 text-justify mb-3"><?php echo $i->deskripsi;?></p>
